...
_CUSTOM_METAWORLD_ENVS = {
    "peg-insert-side-sparse-v3": {
        ...
        "module": "sim_env.envs.versions.v1.sawyer_peg_insertion_side_sparse_v3",
        "class_name": "SawyerPegInsertionSideSparseEnvV3",
    },
    "peg-insert-side-reverse-v3": {
        "benchmark_env_name": "peg-insert-side-v3",
        "module": "sim_env.envs.versions.v1.sawyer_peg_insertion_side_reverse_v3",
    ...
    "peg-insert-side-reverse-shaped-v3": {
        "benchmark_env_name": "peg-insert-side-v3",
        "module": "sim_env.envs.versions.v1.sawyer_peg_insertion_side_reverse_shaped_v3",
