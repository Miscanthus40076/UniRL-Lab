...
from .embodied_encoder import EmbodiedEncoderConfig
...
class DreamerV3PolicyConfig:
    ...
    def validate(self):
        ...
        self.embodied_encoder.validate()
...
def build_dreamerv3_policy_config(policy_config: dict | None) -> tuple[DreamerV3PolicyConfig, DreamerV3CheckpointConfig]:
    ...
    embodied_encoder = EmbodiedEncoderConfig(**dict(raw.pop("embodied_encoder", {})))
    ...
    raw["embodied_encoder"] = embodied_encoder
...
def build_dreamerv3_model_config(
    ...
    return DreamerV3ModelConfig(
        ...
        embodied_encoder=cfg.embodied_encoder,
    )
