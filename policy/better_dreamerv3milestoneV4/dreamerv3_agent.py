...
class DreamerV3Agent:
    ...
    def _probe_slice_metrics(
        ...
        if gripper_slice is not None:
            gripper_mse = self._masked_mse(pred[..., gripper_slice], target[..., gripper_slice])
    ...
    def _augment_batch_with_operator_reward(
        ...
        if (
            ...
            operator_component = float(self.config.operator_intrinsic_reward.beta) * operator_reward
