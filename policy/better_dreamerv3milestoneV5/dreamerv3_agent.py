...
class DreamerV3Agent:
    ...
    def train_actor_value(self, batch: dict[str, torch.Tensor]) -> dict[str, float]:
        ...
        unscaled_slow_gain_intrinsic_mean = float(slow_gain_intrinsics.detach().mean().cpu())
        ...
        return {
            ...
            "actor/slow_gain_intrinsic_mean": unscaled_slow_gain_intrinsic_mean,
            ...
            "actor/event_replay_intrinsic_mean": unscaled_slow_gain_intrinsic_mean,
            ...
            "actor/event_replay_intrinsic_prob_mean": unscaled_slow_gain_intrinsic_mean,
